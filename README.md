...
- [`webui`](webui/README.md) includes recording playback, speaker guidance,
  attendees, and localized corrections, backed by mdstore.
...
nix run github:recmo/all2md#speech2md-worker -- --help
